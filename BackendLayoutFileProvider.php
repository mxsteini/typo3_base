<?php
namespace Cyz\CyzCore2\Provider;
...
/**
 * Class BackendLayoutFileProvider
 * @package Cyz\CyzCore2\Provider
 */
class BackendLayoutFileProvider implements DataProviderInterface {

    const FILE_TYPES_LAYOUT = 'ts,ts1,txt,typoscript';
