var webtrekkConfig = webtrekkConfig || {
    trackId: "639871942536313",
    trackDomain: "generali01.webtrekk.net",
    domain: "REGEXP:.*.badenia.de",
    cookie: "1",
    linkTrack: "link",
    cookieSecure: false
};
...
n=0;n<p.length;n++){var q=a.getMappingParam(p[n]),r=q.mapping,q=q.index;r&&(q?a.config[r]&&("undefined"!==typeof a.config[r][q]&&a.config[r][q])&&(k+="&"+p[n]+"="+a.wtEscape(a.config[r][q])):a.config[r]&&(k+="&"+p[n]+"="+a.wtEscape(a.config[r])))}if("string"===typeof e&&""!==e)for(var s=e.split(/;/),t=0;t<s.length;t++){if("undefined"!==typeof s[t]){var u=s[t].split(/\=/);a.checkSC("custom")&&(u[1]=a.decrypt(u[1]));u[1]=a.wtEscape(u[1]);k+="&"+u[0]+"="+u[1]}}else{a.wtEpEncoded=!1;q=new a.PredefinedParameter;
for(u in a.config)e=u+"",q.put(e,a.config[e]);var x=q.get("all");a.config.customParameter=a.mergeCustomParameter(a.config.customParameter,x.customParameter);u=a.checkCustomParameter(a.config.customParameter,"cp");a.config.customSessionParameter=a.mergeCustomParameter(a.config.customSessionParameter,x.customSessionParameter);e=a.checkCustomParameter(a.config.customSessionParameter,"cs");p=a.checkCustomParameter(a.config.customTimeParameter,"ce");n=a.checkCustomParameter(a.cdb,"cdb");a.config.customEcommerceParameter=
a.mergeCustomParameter(a.config.customEcommerceParameter,x.customEcommerceParameter);r=a.checkCustomParameter(a.config.customEcommerceParameter,"cb");a.config.orderValue&&-1===a.paramFirst.indexOf("ov;")&&(k=a.checkSC("order")?k+("&ov="+a.wtEscape(a.decrypt(a.config.orderValue))):k+("&ov="+a.wtEscape(a.config.orderValue)));a.config.currency&&-1===a.paramFirst.indexOf("cr;")&&(k=a.checkSC("order")?k+("&cr="+a.wtEscape(a.decrypt(a.config.currency))):k+("&cr="+a.wtEscape(a.config.currency)));a.config.orderId&&
...
"ck"),a.ccParams=!1);a.config.xlc&&a.config.xlct&&(""!==a.config.xlc||""!==a.config.xlct)&&(s="",s=a.config.xlcv?a.getExtLifeCycles(a.config.xlc,a.config.xlct,a.config.xlcv):a.getExtLifeCycles(a.config.xlc,a.config.xlct),k+=s);a.config.contentId||a.config.linkId||(a.config.contentId=a.contentId,a.config.linkId="wt_ignore");a.config.linkId?(a.wtEp=k,a.wtEpEncoded=!0,A(a,"noForm",c)):("1"===a.cookie?a.cookieOne&&(k+="&np="+a.wtEscape(d)):k+="&np="+a.wtEscape(d),a.quicksend(b,k))};var e=function(){a.safetagTimeoutStarted=
...
d?(h(d),g(function(){a.quicksend(a.wtEscape(a.contentId.split(";")[0])+",1,"+a.baseparams(),"&cdbeid="+d,"cdb")})):(h("1"),m(c?c:"6"))})):(d="",a.useCDBCache&&a.isIE?d="1":a.useCDBCache&&!b("2d")&&(d="2"),h("1"),m(d)))}};a.cdbeid=!1;a.setProperty("execCDB",!0);a.setProperty("useCDBCache",!1);a.startCDB=function(){c||(a.execCDB=!0,k())};a.execCDB&&k()},la=function(a,d,c){a.eid=!1;a.firstVisitContact=!1;a.firstVisitTimestamp=!1;a.lastVisitContact=!1;a.cookieOne=!1;a.setProperty("globalVisitorIds",!1);
...
na=function(a){a.heatmapOn="1"===a.urlParam(a.wtHref(),"wt_heatmap","0");a.setProperty("heatmapRefpoint","wt_refpoint");a.setProperty("heatmap",!1);var d=function(b){var c,d,h=document.getElementById(a.heatmapRefpoint);d=h&&null!==h?c=0:c=-1;if(h&&null!==h&&"undefined"!==typeof h.offsetLeft)for(;h;)c+=0<=h.offsetLeft?h.offsetLeft:0,d+=0<=h.offsetTop?h.offsetTop:0,h=h.offsetParent;var g=h=0;b||(b=l.event);if(b.pageX||b.pageY)h=b.pageX,g=b.pageY;else if(b.clientX||b.clientY)if(h=b.clientX,g=b.clientY,
a.isIE)if(0<document.body.scrollLeft||0<document.body.scrollTop)h+=document.body.scrollLeft,g+=document.body.scrollTop;else if(0<document.documentElement.scrollLeft||0<document.documentElement.scrollTop)h+=document.documentElement.scrollLeft,g+=document.documentElement.scrollTop;b=0;b=a.isIE?document.body.clientWidth:self.innerWidth-16;var m=!0;if(h>=b||!a.sentFullPixel)m=!1;(0<=d||0<=c)&&(h>c&&g>d)&&(h="-"+(h-c),g="-"+(g-d));m&&"1"===a.heatmap&&(a.executePlugin(a.getPluginConfig("heatmap","before")),
a.quicksend(a.wtEscape(a.contentId.split(";")[0])+","+h+","+g+",,,"+Date.now(),"","hm"+(a.fileSuffix?".pl":"")),a.executePlugin(a.getPluginConfig("heatmap","after")))},c=function(){"undefined"!==typeof l.wt_heatmap?l.setTimeout(function(){l.wt_heatmap()},1E3):("undefined"===typeof l.wt_heatmap_retry&&(l.wt_heatmap_retry=0),l.wt_heatmap_retry++,60>l.wt_heatmap_retry&&l.setTimeout(function(){c()},1E3))};a.heatmapTrackInit=function(){for(var b=!1,c=0;c<l.webtrekkHeatmapObjects.length;c++)a===l.webtrekkHeatmapObjects[c]&&
(b=!0);!b&&(a.heatmap&&"1"===a.heatmap)&&(l.webtrekkHeatmapObjects.push(a),a.registerEvent(document,"mousedown",d),a.registerEvent(document,"touchstart",d))};a.heatmapTrackInit();a.heatmapOn&&!a.disableOverlayView&&a.startHeatmapOrOverlay("heatmap",c)},oa=function(a,d,c){a.setProperty("reporturl","report2.webtrekk.de/cgi-bin/wt");a.setProperty("disableOverlayView",!1);var b=function(b){var c=a.reporturl;-1!==b.search(/^((http[s]?:\/\/)?(report\d+|analytics)\.webtrekk\.(com|de)\/)/)&&(c=b.split("/"),
...
l.webtrekkUnloadObjects[f]&&(b=!0);b||l.webtrekkUnloadObjects.push(a);ma(a);na(a,d,c)})()},pa=function(){var a=this,d="customClickParameter customSessionParameter customCampaignParameter customEcommerceParameter customParameter crmCategory urmCategory contentGroup productCategory".split(" "),c={numberSearchResults:[d[4],771],errorMessages:[d[4],772],loginStatus:[d[1],800],pixelVersion:[d[1],801],trackingPlatform:[d[1],802],npsScore:[d[6],850],npsScoreFeedback:[d[6],851],productLabel:[d[8],870],productMainCategory:[d[8],
...
c.target)b.action="click";d=b.href;var f=d.toLowerCase(),h=d.split("#")[0],g=document.location,l=b.item,k=a.getAttribute,p=k(l,"onclick"),n=k(l,"onmousedown"),l=k(l,"ontouchstart");d=a.noDelayLinkTrackAttribute?!!a.getAttribute(c,a.noDelayLinkTrackAttribute):!(d&&!(0===f.indexOf("javascript:")||0===f.indexOf("#")||"click"===b.action||h===g.href.split("#")[0]&&-1!==d.indexOf("#")||h===g.pathname.split("#")[0]&&-1!==d.indexOf("#")||p&&-1!==p.search(/return false[;]?$/)||n&&-1!==n.search(/return false[;]?$/)||
...
".");d=[];a.linkTrackParams&&(d=a.linkTrackParams.replace(/;/g,",").split(","));for(var f=0;f<d.length;f++){var h=a.urlParam(b.href,d[f],"");h&&(b.linkId+="."+d[f]+"."+h)}}return b.linkId}},sa=function(a){var d=this;d.triggerObjectName="__"+(new Date).getTime()+"_"+parseInt(1E3*Math.random());var c=function(c,b){var h=b[d.triggerObjectName];a.config=a.getConfig(!0);a.config.customClickParameter=a.customClickParameter;a.ccParams=h.getCCParams();var g=a.config.linkId=h.getLinkId();a.sendinfo(a.config,
g,h.action)},b=function(b){a.registerEvent(b,"click",function(f){if(f.which&&1===f.which||f.button&&1===f.button)!a.delayLinkTrack||(f.ctrlKey||f.altKey||f.metaKey||f.shiftKey||"function"!==typeof f.preventDefault||b[d.triggerObjectName].isInternalLink())||(f.preventDefault(),l.setTimeout(function(){document.location.href=b.href},a.delayLinkTrackTime)),c(f,b)})};d.linkTrackInit=function(){if(a.linkTrack&&("link"===a.linkTrack||"standard"===a.linkTrack)){for(var c=!1,f=0;f<l.webtrekkLinktrackObjects.length;f++)a===
l.webtrekkLinktrackObjects[f]&&(c=!0);c||l.webtrekkLinktrackObjects.push(a);c=0;for(f=document.links.length;c<f;c++){var h=document.links[c],g=a.getAttribute(h,a.linkTrackAttribute),m=a.getAttribute(h,"href");(a.linkTrackIgnorePattern&&m&&-1===m.search(a.linkTrackIgnorePattern)||!a.linkTrackIgnorePattern)&&("undefined"===typeof h[d.triggerObjectName]&&(g||"link"===a.linkTrack))&&(h[d.triggerObjectName]=new ra(a,d,h),b(h))}}}},ta=function(a){a.linkTrackObject=new sa(a);a.linkTrackInstall=a.linkTrackObject.linkTrackInit;
a.linkTrackInit=a.linkTrackObject.linkTrackInit;"complete"===document.readyState?a.linkTrackInit():a.registerEvent(l,"load",function(){a.linkTrackInit()})},ua=function(a,d,c){var b=null,e=d.type,f=a.getFormFieldName(d),h=a.getFormFieldValue(d);this.close=function(){null!==b&&(h=a.getFormFieldValue(d),"radio"!==e&&(l.clearInterval(b),b=null,a.formFieldData[f][c]=[e,h]),a.formFieldDataPathAnalysis.push([f,e,h]))};this.start=function(g){null===b&&(b=l.setInterval(function(){"undefined"!==typeof d&&(d&&
...
a:{k=0;for(var l=d.length;k<l;k++)if(h[f][0]===d[k]){k=!0;break a}k=!1}k&&(e=!0,b.push(q(h[f][0],h[f][1],h[f][2],!0)))}e&&(d=b[b.length-1],d=d.substr(0,d.length-1),b[b.length-1]=d+"1")}else return r(c.formFieldData,d);return b.join(";")};c.getFormFieldName=function(b){var c=b.name;a.formFieldAttribute&&(c="",(b=a.getAttribute(b,a.formFieldAttribute))||null!==b)&&(c=b);return c};c.getFormFieldValue=function(b){var d=b.type,e="";if("select-multiple"===d){for(var e=[],f=0,g=b.options,h=g.length;f<h;f++)g[f].selected&&
e.push(n(b,g[f]));0>=e.length&&e.push("empty");e=e.join("|")}else"select-one"===d?(e="",-1!==b.selectedIndex&&((e=n(b,b.options[b.selectedIndex]))&&null!==e||(e="empty"))):"checkbox"===d||"radio"===d?(e="",b.checked?(e=n(b))||(e="checked"):e="empty"):"hidden"!==d&&("button"!==d&&"image"!==d&&"reset"!==d&&"submit"!==d)&&(f=(e=n(b))?"filled_out":"empty",p(b)||(f=e),g=c.getFormFieldName(b),"undefined"!==typeof a.formFieldDefaultValue[g]&&a.formFieldDefaultValue[g]===e&&"empty"!==f&&(f="empty"),f&&null!==
f||(f="empty"),e=f);return p(b)&&"select-multiple"!==d&&"empty"!==e&&"filled_out"!==e?"anon":e};c.formTrackInstall=function(a){c.formObject=a?a:document.forms[0]?document.forms[0]:!1;c.formObject&&(c.form="1",k())};c.getFormTrackingData=function(){var b="";if(c.formObject){var d=t();if(d){var e=c.formSubmit;a.formSubmit&&(e=a.formSubmit);b+="&fn="+a.wtEscape(c.formName)+"%7C"+(e?"1":"0");b+="&ft="+a.wtEscape(d)}c.formSubmit=!1;a.formSubmit=!1;c.formName=!1;c.formObject=!1;c.formFocus=!1;c.formFieldData=
{};c.formFieldDataUnused={};c.formFieldDataPathAnalysis=[]}return b};c.formTrackSubmit=function(){c.formSubmit=!0};c.sendFormRequest=function(){"1"!==a.cookie||(a.optOut||a.deactivatePixel)||a.firstParty();"function"===typeof a.beforeUnloadPixel?a.beforeUnloadPixel():a.executePlugin(a.getPluginConfig("form","before"));var b=c.getFormTrackingData();b&&a.quicksend(a.wtEscape(a.contentId.split(";")[0])+",1,"+a.baseparams(),b);"function"===typeof a.afterUnloadPixel?a.afterUnloadPixel():a.executePlugin(a.getPluginConfig("form",
"after"))};c.updateFormFieldStatus=function(a){if(a&&null!==a&&"undefined"!==typeof a.type){var b=a.type,d=c.getFormFieldName(a),e=c.getFormFieldValue(a);d&&(e&&"undefined"!==typeof c.formFieldData[d])&&(c.formFieldData[d].splice(0,0,[b,e]),c.formFieldDataPathAnalysis.push([d,b,e]),c.formFocus=a,delete c.formFieldDataUnused[d])}};c.init=function(){c.form&&("1"===c.form&&!c.formObject)&&k();return c}},va=function(a){a.multipleFormArray=[];var d=function(b){for(var c=0;c<a.multipleFormArray.length;c++)if(a.multipleFormArray[c].formObject===
b)return a.multipleFormArray[c];return!1},c=function(b){if(b&&"undefined"!==typeof b.elements&&!d(b)){var c=new D(a,function(b){A(a,"form","form",b)});a.multipleFormArray.push(c);c.formTrackInstall(b)}};a.multipleFormTrackInstall=c;a.multipleFormTrackInit=c;a.multipleFormTrackSubmit=function(a){a&&(a=d(a))&&a.formTrackSubmit()};a.sendMultipleFormRequest=function(b){if(b)(b=d(b))&&b.sendFormRequest();else for(b=0;b<a.multipleFormArray.length;b++)a.multipleFormArray[b].sendFormRequest()};a.updateMultipleFormFieldStatus=
function(a,c){if(a){var f=d(a);f&&f.updateFormFieldStatus(c)}}},wa=function(a,d){var c=this;c.name=a?a:"";c.elements=d?d:[];c.add=function(a){a&&null!==a&&c.elements.push(a);return c};c.getAttribute=function(){return a};c.addEventListener=c.removeEventListener=function(){}},A=function(a,d,c,b){"1"!==a.cookie||(a.optOut||a.deactivatePixel)||a.firstParty();(c=c?c:"")||(c=a.formObject&&"noForm"!==d?"form":"link");"function"===typeof a.beforeUnloadPixel?a.beforeUnloadPixel():"form"===c&&a.executePlugin(a.getPluginConfig("form",
"before"));var e="";if(a.config.linkId&&(e+="&ct="+a.wtEscape(a.maxlen(a.wtUnescape(a.config.linkId),255)))){var f=a.ccParams;"string"===typeof f&&""!==f&&(e+=f)}if(a.wtEp)if(a.wtEpEncoded)e+=a.wtEp;else if(f=a.wtEp,"string"===typeof f&&""!==f)for(var f=f.split(/;/),h=0;h<f.length;h++)if("undefined"!==typeof f[h]){var g=f[h].split(/\=/);a.checkSC("custom")&&(g[1]=a.decrypt(g[1]));g[1]=a.wtEscape(g[1]);e+="&"+g[0]+"="+g[1]}"noForm"!==d&&(e+=b.getFormTrackingData());""!==e&&(a.quicksend(a.wtEscape(a.contentId.split(";")[0])+
",1,"+a.baseparams(),e),a.config.linkId="",a.ccParams="",a.wtEp="");"function"===typeof a.afterUnloadPixel?a.afterUnloadPixel():"form"===c&&a.executePlugin(a.getPluginConfig("form","after"))},xa=function(a){a.formTrackObject=new D(a,function(d){A(a,"form","form",d)});a.formTrackInstall=a.formTrackObject.formTrackInstall;a.formTrackInit=a.formTrackObject.formTrackInstall;a.formTrackSubmit=a.formTrackObject.formTrackSubmit;a.sendFormRequest=a.formTrackObject.sendFormRequest;a.updateFormFieldStatus=
a.formTrackObject.updateFormFieldStatus;"complete"===document.readyState?a.formTrackObject.init():a.registerEvent(l,"load",function(){a.formTrackObject.init()});a.CustomForm=wa;va(a)},ya=function(){var a="",d="",c=!1,b=!0,e=0,f=null,h=!1,g=function(){},m=function(){},k=function(a,b,c){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent&&a.attachEvent("on"+b,c)},p=function(){var a=1E3;f=l.setInterval(function(){0>=a&&(l.clearInterval(f),h=!1,c||(b=!0,e++,g(e)));a-=5},5)};this.isPageHidden=
function(){return c};this.isPageVisible=function(){return b};this.setVisibleCall=function(a){g=a};this.setHiddenCall=function(a){m=a};"undefined"!==typeof document.hidden?(a="hidden",d="visibilitychange"):"undefined"!==typeof document.mozHidden?(a="mozHidden",d="mozvisibilitychange"):"undefined"!==typeof document.msHidden?(a="msHidden",d="msvisibilitychange"):"undefined"!==typeof document.oHidden?(a="oHidden",d="ovisibilitychange"):"undefined"!==typeof document.webkitHidden&&(a="webkitHidden",d="webkitvisibilitychange");
a&&(c=document[a],(b=!c)&&e++,function(){k(document,d,function(){(c=document[a])?(l.clearInterval(f),b=h=!1,m()):h||(h=!0,p())})}())},za=function(a){a.setProperty("tabBrowsing",!1);var d=[],c=[],b=null,e=function(){b=new ya;b.setVisibleCall(function(b){if(1<b&&0<c.length){var e=c[0].split("&");b-=1;e[1]="tb="+b+"&cp770="+b+"&"+e[1];a.sendPixel(e.join("&"),c[1])}for(var g=0,l=d.length;g<l;g++)e=d[g][0],b=d[g][1],a.sendPixel(e,b),"wt"===b&&-1===e.search(/&(ct|fn|ft)=.+&/)&&(c=[e,b]);d=[]})};a.tabBrowsing&&
e();a.sendTabBrowsingPixel=function(e,h){b.isPageVisible()?(a.sendPixel(e,h),"wt"===h&&-1===e.search(/&(ct|fn|ft)=.+&/)&&(c=[e,h])):d.push([e,h])};a.startTabBrowsing=function(){null===b&&(a.tabBrowsing=!0,e())}};l.webtrekkV3=l.WebtrekkV3=function(a){var d=l.webtrekkConfig;a||(a=l.webtrekkConfig);this.version="447";for(var c=[M,X,Y,aa,ca,ja,la,oa,qa,ta,xa,za],b=0;b<c.length;b++)c[b](this,a,d)}})(window);
